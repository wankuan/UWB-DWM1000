...
void DWM1000_While_Handle()
{
			if (HAL_UART_Receive(&UART1_Handler, (uint8_t*)&ch, 1, 0) == HAL_OK) 
					{
      handleInput(ch);
    }
    if (mode == modeSniffer) {
