...
#define APP_NAME "LPLISTEN RX v1.0"
 ...
 * RX ON time of 3*16 symbols, or around 48 탎. See NOTE 2 below. */
#define LPL_RX_SNIFF_TIME 2

/* Snooze ("short sleep") time, expressed in multiples of 512/19.2 탎 (~26.7 탎).
 * The IC automatically adds 1 to the value set so the snooze time of 4 here gives 5*512/19.2 탎 (~133 탎). See NOTE 2 below. */
